    ...
    def pushed_go_practice(self):
        ...
        if not self.inOrder:
            ...
            if len(list(self.lang.orderWords_list.keys())) > 0:
                ...
                self.order_over.over_text.setText(f"""<html><head/><body><p align=\"center\"><span style=\" font-size:20pt; font-weight:600;\">{len(list(self.lang.words_list.keys()))} adet kelime çalışması</span></p><p align=\"center\"><span style=\" font-size:20pt; font-weight:600;\">sona erdi!</span></p></body></html>""")
